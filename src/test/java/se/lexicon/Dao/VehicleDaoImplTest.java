...
public interface VehicleDaoImplTest {

    VehicleDao testObject = null; // Declaring VehicleDao instance for testing
    ...
    public default void setUp() {
        VehicleDao testObject = VehicleDaoImpl.getInstance(); // Initializing VehicleDao instance
    }

    @Test
    public default void testCreate() {
    ...
    @Test
    public default void testRemove() {
    ...
    @Test
    public default void testUpdate() {
    ...
    @Test
    public default void testFindByCustomerId() {
